...
import info.ejava.examples.db.validation.contacts.NullPOCConfiguration;
...
public class POCServiceValidationNTest {
    @Autowired
    ...
    @Test
    void created_response_cannot_be_null() {
        //verify
        PersonPocDTO validPOC = pocFactory.make();
        assertThatThrownBy(() -> pocService.createPOC(validPOC))
                .isInstanceOf(ConstraintViolationException.class)
                .hasMessageContaining("createPOC.<return value>: must not be null");
    }
    ...
    @Test
    void created_poc_cannot_be_null() {
        //given
        PersonPocDTO poc = PersonPocDTO.builder()
                .firstName("manny")
                .lastName("pep")
                .build();
        //verify
        assertThatThrownBy(() -> pocService.createPOC(poc))
                .isInstanceOf(ConstraintViolationException.class)
                .hasMessage("createPOC.<return value>: must not be null");
    }
}
